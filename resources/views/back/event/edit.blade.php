...
<div class="row" id='create-event'>
                ...
                <form action="{{route('event.update', $event->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description"class="form-control" placeholder="Description de l'Évènement">{{$event->description}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <input name="prix_adherent" value="{{$event->prix_adherent}}"type="text" class="form-control" id="exampleFormControlInput1" placeholder="Prix">
                                    @if($errors->has('prix_adherent')) <span class="error bg-warning ">{{$errors->first('prix_adherent')}}</span>@endif
                                </div>
                            <div class="form-group">
            ...
            <div class="col-md-6 create-right">
                    <div class="form-group">
                            <label for="lien_evenement">Billeterie :</label>
                            <textarea type="text" name="lien_evenement"class="form-control" placeholder="Lien du formulaire de l'évènement">{{$event->lien_evenement}}</textarea>
                            @if($errors->has('lien_evenement')) <span class="error bg-warning ">{{$errors->first('lien_evenement')}}</span> @endif
                        </div>
